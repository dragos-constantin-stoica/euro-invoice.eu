...
const messages = {
  gb: {
    ...
    login: {
      ...
      password: 'Password:',
      btn_login: 'Login',
      btn_register: 'Register NEW Company'
    },
    register: {
      grp_user: 'Company Admin',
      grp_company: 'Company data',
  ...
  fr: {
    ...
    login: {
      ...
      btn_login: 'Connexion',
      btn_register: 'Enregister NOUVELLE Entreprise'
    },
    register: {
    ...
    company:{
      name: "Nom",
      national_registration_number: "Numero National",
      country: "Pays",
      vat: "T.V.A",
      address: "Adress",
  ...
  ro: {
    ...
    login: {
      ...
      password: 'Parola :',
      btn_login: 'Conectare',
      btn_register: 'Enregistati Companie NOUA'
    },
    register: {
      grp_user: 'Cont Administrator',
      grp_company: 'Date Companie',
      name: 'Nume complet:',
    ...
    company:{
      name: "Nume",
      national_registration_number: "Numarul National de Inregistrare",
      country: "Tara",
      vat: "Numar T.V.A",
      address: "Adresa",
